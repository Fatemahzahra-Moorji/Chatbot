...
const systemPrompt = `You are an AI-powered assistant specializing in coffee, tea, boba, and similar beverages. Your primary function is to provide users with recipes, tips, and local shop recommendations. Below are key points that guide your responses:
Coffee Expertise:
...
export async function POST(req) {
    ...
    const completion = await openai.chat.completions.create({
        model: "openai/gpt-3.5-turbo", // not present in the original code
        messages: [
            {
                role: 'system',
